...
def main():
    ...
    parser.add_argument("--n", type=int, help='Value of n (default=2). (Used only in example 2)', default=2)
    parser.add_argument("--pdf", type=str, help='PDF image output filename (Used only in example 1.)', default='bdd.pdf')
